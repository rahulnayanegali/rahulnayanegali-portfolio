...
export default function contact() {
  return (
    <div id="contact" className=" flex items-center sm:flex-row flex-col">
      <p className="text-md text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2
      ...
      >
        ...
        >
          <img
            ...
            className=""
            src={linkedinIcon}
            alt="https://freeicons.io/social-media-icons-4/linkedin-icon-15649#"
          />
        </a>
        <a
          className="text-gray-700 mx-2 text-xl transform hover:scale-150
        ...
        >
          <img
            ...
            className=""
            src={githubIcon}
            alt="https://freeicons.io/common-style-icons-8/github-icon-11674"
          />
        </a>
      </span>
    </div>

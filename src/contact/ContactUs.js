...
export default function ContactUs() {
  ...
  <form className="w-full max-w-lg mb-4 px-6 py-4 shadow-lg" onSubmit={handleSubmit(sendEmail)}>
    ...
    <div className="flex flex-wrap -mx-3 mb-6">
        ...
        <input name="email" ref={register({ required: "Email Required"})} className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="email" type="email" placeholder="rahulan@company.io"/>
